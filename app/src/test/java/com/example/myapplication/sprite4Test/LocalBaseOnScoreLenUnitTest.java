...
public class LocalBaseOnScoreLenUnitTest {
    ...
    public void localBaseOnScoreLen() {
        ...
        int offsetOne = Leaderboard.getInstance().calScoreOffset(Integer.toString(s1.getScore()).length());
        int offsetTwo = Leaderboard.getInstance().calScoreOffset(Integer.toString(s2.getScore()).length());
