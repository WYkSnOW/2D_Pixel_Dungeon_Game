...
public class LeaderboardVerifyPlayerNameUnitTest {
    ...
    public void verifyPlayerNameOnPlayerName() {
        //Make 3 different scores with different names and check if the leaderboard displays them corrrectly
        ...
        assertEquals(Leaderboard.getInstance().getPlayerRecords().get(0).getPlayerName(), score1.getPlayerName());
        assertEquals(Leaderboard.getInstance().getPlayerRecords().get(1).getPlayerName(), score2.getPlayerName());
        assertEquals(Leaderboard.getInstance().getPlayerRecords().get(2).getPlayerName(), score3.getPlayerName());
    }
}
